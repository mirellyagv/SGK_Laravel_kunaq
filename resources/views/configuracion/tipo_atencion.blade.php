    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <p class="page-title"><a class="text-reset" href="{{ url('configuracion') }}"><b>Configuración</b></a> <span class="uri-seg"> > </span>Tipo de Atención</p>
            </div>
        </div>
    </div>
                        ...
                        <div class="row create">
                            <div class="col-lg-12">
                                <div class="card border">
                                    ...
                                    <div class="card-body">
                                        <form id="FrmTipoAtencion">
                                            @csrf
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>Descripcion:</label>
                                                        <input type="text" class="form-control vali" name="dsc_tipo_atencion" id="dsc_tipo_atencion" autocomplete="off">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>Estado Atención:</label><br>
                        ...
                        <div class="row lista">
                            <div class="col-md-12 mt-3">
                                <div class="card border">
                                    ...
                                    <div class="card-body table-responsive table_tipo_atencion">
                                        <table id="table-list" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><a href="javascript:void(0)" class="uri-seg editar" id="{{ $a->id }}" title="EDITAR" nom="{{ $a->dsc_tipo_atencion }}"><i class="fas fa-edit"></i></a></td>
                                                    <td>{{ $a->dsc_tipo_atencion }}</td>
    ...
    <script>
        $(function() {
            ...
            $(".nuevo").on('click',function() {
                $(".titulo").html('Creación de un nuevo tipo de atención');
                $(".lista").hide();
                $("#FrmTipoAtencion")[0].reset();
                $("#xid").val('');
                $(".create").show();
            });
            ...
            $(".enviar").on('click',function() {
                Frm = $("#FrmTipoAtencion").serializeArray();
                v = 0;
                $("#FrmTipoAtencion").find(".vali").each(function(){
                    if ($(this).val() == "") {
                        v = 1;
                    }
                });
                ...
                $.post(" {{ url('config/man-atencion') }} ",Frm,function(r) {
                    if (r.confirm == 1) {
            ...
            $(".table_tipo_atencion").on('click','.editar',function() {
                id = $(this).attr('id');
                tit = $(this).attr('nom');
                $(".titulo").html('Modificación de '+tit);
                $.post("{{ url('config/get-atencion') }}",{id:id,_token:tk},function(r) {
                    $.each(r,function(i,k) {
                        $("#dsc_tipo_atencion").val(k.dsc_tipo_atencion);
                        if (k.flg_activo) {
