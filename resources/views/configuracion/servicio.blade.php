    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <p class="page-title"><a class="text-reset" href="{{ url('configuracion') }}"><b>Configuración</b></a> <span class="uri-seg"> > </span>Servicios</p>
            </div>
        </div>
    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control vali" name="dsc_servicio" id="dsc_servicio" autocomplete="off">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                        ...
                                        <table id="table-list" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><a href="javascript:void(0)" class="uri-seg editar" id="{{ $s->id }}" title="EDITAR" nom="{{ $s->dsc_servicio }}"><i class="fas fa-edit"></i></a></td>
                                                    <td>{{ $s->dsc_servicio }}</td>
    ...
    <script>
        $(function() {
            ...
            $(".nuevo").on('click',function() {
                $(".titulo").html('Creación de un nuevo servicio');
                $(".lista").hide();
            ...
            $(".enviar").on('click',function() {
                Frm = $("#FrmServicios").serializeArray();
                v = 0;
                $("#FrmServicios").find(".vali").each(function(){
                    if ($(this).val() == "") {
                        v = 1;
                    }
                });
                ...
                $.post(" {{ url('config/man-servicios') }} ",Frm,function(r) {
                    if (r.confirm == 1) {
            ...
            $(".table_servicios").on('click','.editar',function() {
                ...
                $.post("{{ url('config/get-servicios') }}",{id:id,_token:tk},function(r) {
                    $.each(r,function(i,k) {
                        $("#dsc_servicio").val(k.dsc_servicio);
                        if (k.flg_activo) {
