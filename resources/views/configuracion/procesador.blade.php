    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <p class="page-title"><a class="text-reset" href="{{ url('configuracion') }}"><b>Configuración</b></a> <span class="uri-seg"> > </span>Procesador</p>
            </div>
        </div>
    </div>
                        ...
                        <div class="row create">
                            <div class="col-lg-12">
                                <div class="card border">
                                    ...
                                    <div class="card-body">
                                        <form id="FrmProcesador">
                                            @csrf
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>Descripcion:</label>
                                                        <input type="text" class="form-control vali" name="dsc_procesador"  id="dsc_procesador" autocomplete="off">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                        ...
                        <div class="row lista">
                            <div class="col-md-12 mt-3">
                                <div class="card border">
                                    ...
                                    <div class="card-body table-responsive table_procesador">
                                        <table id="table-list" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><a href="javascript:void(0)" class="uri-seg editar" id="{{ $p->id }}" title="EDITAR" nom="{{ $p->dsc_procesador }}"><i class="fas fa-edit"></i></a></td>
                                                    <td>{{ $p->dsc_procesador }}</td>
    ...
    <script>
        $(function() {
            ...
            $(".nuevo").on('click',function() {
                $(".titulo").html('Creación de procesador');
                $(".lista").hide();
                $("#FrmProcesador")[0].reset();
                $("#xid").val('');
                $(".create").show();
            });
            ...
            $(".enviar").on('click',function() {
                Frm = $("#FrmProcesador").serializeArray();
                v = 0;
                $("#FrmProcesador").find(".vali").each(function(){
                    if ($(this).val() == "") {
                        v = 1;
                    }
                });
                ...
                $.post(" {{ url('config/man-procesador') }} ",Frm,function(r) {
                    if (r.confirm == 1) {
            ...
            $(".table_procesador").on('click','.editar',function() {
                id = $(this).attr('id');
                tit = $(this).attr('nom');
                $(".titulo").html('Modificación de '+tit);
                $.post("{{ url('config/get-procesador') }}",{id:id,_token:tk},function(r) {
                    $.each(r,function(i,k) {
                        $("#dsc_procesador").val(k.dsc_procesador);
                        if (k.flg_activo) {
