    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <p class="page-title"><a class="text-reset" href="{{ url('configuracion') }}"><b>Configuración</b></a> <span class="uri-seg"> > </span>Categoría Software</p>
            </div>
        </div>
    </div>
                        ...
                        <div class="row create">
                            <div class="col-lg-12">
                                <div class="card border">
                                    ...
                                    <div class="card-body">
                                        <form id="FrmCategoriaSoftware">
                                            @csrf
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>Descripcion:</label>
                                                        <input type="text" class="form-control vali" name="dsc_categoria"  id="dsc_categoria" autocomplete="off">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                        ...
                        <div class="row lista">
                            <div class="col-md-12 mt-3">
                                <div class="card border">
                                    ...
                                    <div class="card-body table-responsive table_categoria">
                                        <table id="table-list" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><a href="javascript:void(0)" class="uri-seg editar" id="{{ $c->id }}" title="EDITAR" nom="{{ $c->dsc_categoria }}"><i class="fas fa-edit"></i></a></td>
                                                    <td>{{ $c->dsc_categoria }}</td>
    ...
    <script>
        $(function() {
            ...
            $(".nuevo").on('click',function() {
                $(".titulo").html('Creación de categoría');
                $(".lista").hide();
                $("#FrmCategoriaSoftware")[0].reset();
                $("#xid").val('');
                $(".create").show();
            });
            ...
            $(".enviar").on('click',function() {
                Frm = $("#FrmCategoriaSoftware").serializeArray();
                v = 0;
                $("#FrmCategoriaSoftware").find(".vali").each(function(){
                    if ($(this).val() == "") {
                        v = 1;
                    }
                });
                ...
                $.post(" {{ url('config/man-categoria') }} ",Frm,function(r) {
                    if (r.confirm == 1) {
            ...
            $(".table_categoria").on('click','.editar',function() {
                id = $(this).attr('id');
                tit = $(this).attr('nom');
                $(".titulo").html('Modificación de '+tit);
                $.post("{{ url('config/get-categoria') }}",{id:id,_token:tk},function(r) {
                    $.each(r,function(i,k) {
                        $("#dsc_categoria").val(k.dsc_categoria);
                        if (k.flg_activo) {
