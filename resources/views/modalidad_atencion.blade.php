    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <p class="page-title"><a class="text-reset" href="{{ url('configuracion') }}"><b>Resumen de Soporte Técnico</b></a> <span class="uri-seg"> > </span>Modalidad de Atención</p>
            </div>
        </div>
    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select name="tipo_atencion" class="form-control">
                                                <option value="">Seleccione</option>
                                                @foreach($ts as $s)
                                                <option value="{{$s->id}}">{{ $s->dsc_tipo_soporte }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
    ...
    <script>
        $(function() {
            ...
            $(".filtro").on('click',function() {
                ...
                $(".pie").empty();
                $.post("{{ url('soporte/modalidad') }}",Frm,function(r) {
                    $(".pie").html(r);
                });
            });
            ...
            $(".filtro-l").on('click',function() {
                ...
                $(".lineal").empty();
                $.post("{{ url('soporte/modalidad-lineal') }}",Frm,function(r) {
                    $(".lineal").html(r);
                });
            });
            ...
            $(".filtro-b").on('click',function() {
                ...
                $(".barra").empty();
                $.post("{{ url('soporte/modalidad-barra') }}",Frm,function(r) {
                    $(".barra").html(r);
                });
            });
        });
